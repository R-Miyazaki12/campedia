    ...
    for (const site of CAMPSITES) {
        await prisma.campsite.upsert({
            ...
            create: {
                ...
                editorVoice: site.editorVoice,
                lat: site.location.lat,
                lng: site.location.lng,
                address: site.location.address,
                accessNote: site.location.accessNote || null,
                vibeTags: JSON.stringify(site.features.vibe),
                noiseLevel: site.features.noiseLevel,
                ...
                nearbySuperTime: site.nearby.supermarket?.driveTimeMin || null,
                ratingTotal: site.rating.total,
                ratingNature: site.rating.nature,
                ratingFacilities: site.rating.facilities,
                ratingCleanliness: site.rating.cleanliness,
                ratingAccess: site.rating.access,
                ratingQuietness: site.rating.quietness,
                reviews: {
                    create: site.reviews.map(r => ({
                        id: r.id,
                        userName: r.userName,
                        date: new Date(r.date),
                        content: r.content,
                        ratingTotal: r.rating,
                        ratingNature: site.rating.nature, // Hack: using site average for existing reviews as we don't have per-review metrics in mock
                        ratingFacilities: site.rating.facilities,
                        ratingCleanliness: site.rating.cleanliness,
                        ratingAccess: site.rating.access,
                        ratingQuietness: site.rating.quietness,
